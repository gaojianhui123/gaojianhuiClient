...
@Component({
  selector: 'app-tanhuashenqinginfo-list',
...
export class TanhuashenqinginfoListComponent implements OnInit {
  ...
  add() {
    this.router.navigate(['/tanhuashenqinginfo/tanhuashenqinginfosave']);
  }

  goToEdit(id: any) {
    this.router.navigate(['/tanhuashenqinginfo/tanhuashenqinginfosave', {id: id}]);
  }
